...
GRANT USAGE ON DATABASE VIEW_DB TO SHARE share_cust_data;
GRANT USAGE ON SCHEMA VIEW_DB.public TO SHARE share_cust_data;
...
GRANT SELECT ON TABLE VIEW_DB.public.CUSTOMER_INFO TO SHARE share_cust_data;
...
ALTER SHARE share_cust_data ADD ACCOUNT=consumer_number_here;
